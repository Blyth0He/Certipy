...
class ActiveDirectorySecurity:
    ...
    def __init__(
        ...
        for ace in aces:
            ...
            # control access right will not take effect if the ADS_RIGHT_DS_CONTROL_ACCESS flag is not set(preventing
            ...
            # refer to https://learn.microsoft.com/en-us/windows/win32/api/winnt/ns-winnt-access_allowed_object_ace
